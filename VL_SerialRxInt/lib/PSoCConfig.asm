...
export LoadConfig_vl_serialrxint
export _LoadConfig_vl_serialrxint
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_vl_serialrxint
	lcall	LoadConfigTBL_vl_serialrxint_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration vl_serialrxint
;
;    Load configuration registers for vl_serialrxint.
...
;               CUR_PP
;
_LoadConfig_vl_serialrxint:
 LoadConfig_vl_serialrxint:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_vl_serialrxint_Bank0
    mov     X, <LoadConfigTBL_vl_serialrxint_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_vl_serialrxint_Bank1
    mov     X, <LoadConfigTBL_vl_serialrxint_Bank1
