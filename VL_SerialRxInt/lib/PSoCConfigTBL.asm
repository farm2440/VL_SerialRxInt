...
export LoadConfigTBL_vl_serialrxint_Bank1
export LoadConfigTBL_vl_serialrxint_Bank0
export LoadConfigTBL_vl_serialrxint_Ordered
AREA lit(rom, rel)
LoadConfigTBL_vl_serialrxint_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_vl_serialrxint_Bank1:
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB03)
...
LoadConfigTBL_vl_serialrxint_Ordered:
